...
$('.select-box__selected').on('click', function () {
    let $this = $(this),
...
let $selectedMark = $('.select-box__selected[data-type="mark"]'),
    $selectBoxDropdownMark = $('.select-box__dropdown[data-type="mark"]'),
    $markLi = $selectBoxDropdownMark.find('.select-box__dropdown--li'),

    $selectedModel = $('.select-box__selected[data-type="model"]'),
    $selectBoxDropdownModel = $('.select-box__dropdown[data-type="model"]'),
    $modelLi = $selectBoxDropdownModel.find('.select-box__dropdown--li'),

    $selectedYear = $('.select-box__selected[data-type="year"]'),
    $selectBoxDropdownYear = $('.select-box__dropdown[data-type="year"]'),
    $yearLi = $selectBoxDropdownYear.find('.select-box__dropdown--li'),
...
$markLi.on('click', function () {
    let $this = $(this),
        thisMark = $this.attr('data-mark'),
        $thisModels = $selectBoxDropdownModel.find(`.select-box__dropdown--li[data-mark='${thisMark}']`),
        $notThisModels = $selectBoxDropdownModel.find(`.select-box__dropdown--li:not([data-mark='${thisMark}'])`);

    selectedMark = thisMark;
    selectedModel = '';

    $selectedMark.html(selectedMark);
    $selectedModel.html('Модель авто');
...
$modelLi.on('click', function () {
    ...
    $selectedMark.html(selectedMark);
    $selectedModel.html(selectedModel);
});
